...
<div class="bg-gray-800 rounded-lg p-6">
    <h1 class="text-2xl font-bold text-white mb-6 uppercase">Lịch Thi Đấu Bóng Đá Hôm Nay, LTĐ Bóng Đá Anh, C1, C2, La Liga</h1>
                        ...
                        @foreach($matches as $match)
                            ...
                            <div class="grid grid-cols-11 gap-2 px-4 py-3 border-b border-gray-700 hover:bg-gray-800 transition-colors">
                                ...
                                <div class="col-span-3">
                                    <div class="text-xs text-gray-400 mb-2">{{ $matchTimeStr }}</div>
                                    <!-- Home Team -->
