                ...
                <table class="w-full text-sm">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-700 hover:bg-gray-700 transition-colors">
                            <td class="px-4 py-3 text-gray-300">{{ $team['overall']['position'] ?? $loop->iteration }}</td>
                            <td class="px-4 py-3">
                                ...
                                <div class="flex items-center justify-center gap-1">
                                    @if(isset($team['recent_form']) && !empty($team['recent_form']))
                                        @foreach(str_split($team['recent_form']) as $result)
                                            @if($result === 'W')
                                                <span class="w-5 h-5 bg-green-500 rounded text-xs flex items-center justify-center text-white font-bold">W</span>
                                            @elseif($result === 'D')
                                                <span class="w-5 h-5 bg-yellow-500 rounded text-xs flex items-center justify-center text-white font-bold">D</span>
                                            @else
                                                <span class="w-5 h-5 bg-red-500 rounded text-xs flex items-center justify-center text-white font-bold">L</span>
                                            @endif
                                        @endforeach
                                    @endif
                                </div>
